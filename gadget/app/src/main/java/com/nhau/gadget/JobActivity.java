...
public class JobActivity extends ActionBarActivity
    ...
    private static JobActivity instance;
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((JobActivity) activity).onSectionAttached(
    ...
    public void startTask(String id) {
        ...
        try {
            ...
            myAsyncTask mTask = new myAsyncTask(get_context(), JobActivity.this,id);
    ...
    class myAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        private ProgressDialog dialog = new ProgressDialog(JobActivity.this);
        String result = "";
        Activity _activity;
        Context _context;
        String _id;
