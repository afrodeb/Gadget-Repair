...
class TeachersController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','assignteacher'),
				'users'=>array('*'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Teachers']))
		{
			...
			$user->email=$model->ecnumber;
			$user->role="Teacher";
			$user->password=substr($model->dob,0,4).$model->ecnumber;
...
$str=$teacher->assignTeacher($id,$class);
echo $str;
