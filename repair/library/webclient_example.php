...
$conn = new XMPPHP_BOSH('127.0.0.1',9090, 'admin', 'gabby&kudaprezha', 'xmpphp', '127.0.0.1', $printlog=true, $loglevel=XMPPHP_Log::LEVEL_INFO);
$conn->autoSubscribe();
...
try {
	...
	$conn->connect('http://127.0.0.1:9090/xmpp-httpbind', 1, true);
	#while(true) {
